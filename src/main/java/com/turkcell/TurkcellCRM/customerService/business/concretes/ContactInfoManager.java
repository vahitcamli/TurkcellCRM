...
public class ContactInfoManager implements ContactInfoService {
	...
	public GetContactInfoResponse getById(int id) {
		...
		GetContactInfoResponse getContactInfoResponse = modelMapperService.forResponse().map(contactInfo,
				GetContactInfoResponse.class);
	...
	public UpdatedContactInfoResponse update(UpdateContactInfoRequest updateContactInfoRequest, int contactInfoId) {
		...
		ContactInfo contactInfoToUpdate = modelMapperService.forRequest().map(updateContactInfoRequest,
				ContactInfo.class);
	...
	public List<GetAllContactInfoResponse> getAll() {
		...
		return contactInfos.stream()
				.map(contactInfo -> modelMapperService.forResponse().map(contactInfo, GetAllContactInfoResponse.class))
				.toList();
	}
}