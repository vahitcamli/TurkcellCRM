...
public class IndividualCustomerManager implements IndividualCustomerService {
	...
	public CreatedIndividualCustomerResponse add(CreateIndividualCustomerRequest createIndividualCustomerRequest) {
		...
		IndividualCustomer customer = modelMapperService.forRequest().map(createIndividualCustomerRequest,
				IndividualCustomer.class);
		customer.setCreatedDate(LocalDateTime.now());

		IndividualCustomer createdCustomer = individualCustomerRepository.save(customer);

		IndividualCustomerCreatedEvent customerCreatedEvent = modelMapperService.forResponse().map(createdCustomer,
				IndividualCustomerCreatedEvent.class);
	...
	public GetIndividualCustomerResponse getById(int id) {
		...
		GetIndividualCustomerResponse getCustomerResponse = modelMapperService.forResponse().map(individualCustomer,
	...
	@Transactional
	@Override
	public UpdatedIndividualCustomerResponse update(UpdateIndividualCustomerRequest updateCustomerRequest,
			int customerId) {

		individualCustomerBusinessRules.customerShouldBeExists(customerId);
		individualCustomerBusinessRules.checkMernis(
				modelMapperService.forRequest().map(updateCustomerRequest, CreateIndividualCustomerRequest.class)); // TODO:
																													// Buraya
																													// bakılacak

		IndividualCustomer customerToUpdate = modelMapperService.forRequest().map(updateCustomerRequest,
				IndividualCustomer.class);
	...
	public List<GetAllIndividualCustomerResponse> getAll() {
		...
		return customers.stream()
				.map(customer -> modelMapperService.forResponse().map(customer, GetAllIndividualCustomerResponse.class))
				.toList();
	}
}